...
import { Upload, Check, Trash2, Image as ImageIcon, RotateCcw } from "lucide-react";
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-950/40 p-6 flex flex-col justify-between">
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded border border-zinc-850 bg-zinc-900/40 hover:bg-zinc-800 disabled:opacity-30 disabled:cursor-not-allowed px-4 py-2.5 text-xs font-bold text-zinc-300 transition-colors uppercase tracking-wider cursor-pointer"
            >
